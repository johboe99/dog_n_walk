...
dog_1 = Dog.create(name: "Romy", breed: "Labrador Retriever", age: 5, description: "Hi, I am Romy, a friendly, young Lady from Hamburg. I love long walks, sticks and carrots and anyone with food.", user: user_1)
...
dog_2 = Dog.create(name: "Ginny", breed: "Dachshound-Mix", age: 7, description: "I love being the center of attention but I don't like walking in the rain.", user: user_2)
...
puts "dog 2rails  created"

dog_3 = Dog.create(name: "Rudi", breed: "Irish-Wolfhound", age: 8, description: "Hi, I am a gentle giant from Falkensee that loves sleeping and steeling food from the table.", user: user_3)
...
dog_4 = Dog.create(name: "Doge", breed: "Shiba Inu", age: 12, description: "I am a former celebrity, such fame. I also love trading my currency, much coins. Wow.", user: user_4)
...
dog_5 = Dog.create(name: "Phteven", breed: "Chihuahua-Dachshound", age: 3, description: "My name is Phteven. I love going to McDonald's but I hate that they spell my name wrong each time", user: user_4)
file = URI.open("https://res.cloudinary.com/dsrno7wgu/image/upload/v1732193138/IMG_9395_xpeqjh.jpg")
